        ...
        <div className="card-container">
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              ...
              <span className="puma-defi">
                Puma Scuderia Ferrari Sptwr <br /> Race Rosso Corsa Baseball{" "}
                <br /> Cap
              </span>
          ...
          <div className="card-1" onClick={() => navigate("product")}>
            ...
            <div className="featurs">
              <span className="pumatext">Puma</span>
              <span className="puma-defi">
                Puma BMW M Motorsport <br />
                Statement Black Baseball <br />
                Cap{" "}
              </span>
          ...
          <div className="card-1" onClick={() => navigate("product")}>
            ...
            <div className="featurs">
              ...
              <span className="puma-defi">
                adidas Black Solid Baseball <br /> Cap
              </span>
        ...
        <div className="card-container">
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              ...
              <span className="puma-defi">
                Royel Enfield Tornadoes <br />
                Olive Green Solid Baseball <br /> Cap
              </span>
          ...
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              <span className="pumatext">Royel Enfield</span>
              <span className="puma-defi">
                Royel Enfield Military <br />
                Green Solid Baseball <br />
                Cap{" "}
              </span>
          ...
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              <span className="pumatext">adidas</span>
              <span className="puma-defi">
                adidas Black Solid Beanies- <br /> Small
              </span>
        ...
        <div className="card-container">
          ...
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              ...
              <span className="puma-defi">
                Peter England Olive Green <br /> Baseball Cap
              </span>
          ...
          <div className="card-1" onClick={() => navigate("Product")}>
            ...
            <div className="featurs">
              <span className="pumatext">Royel Enfield</span>
              <span className="puma-defi">
                Royel Enfield Trucker Dark <br /> Blue Solid Baseball cap{" "}
              </span>
