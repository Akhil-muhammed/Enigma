...
const Cartitem = (props) => {
  ...
  return (
    ...
    <div className='pricebutton'>
      ...
      <button onClick={()=>removeFromCart(id)} className='-button'>-</button>
      <span>{cartitems[id]}</span>
      <button onClick={()=>addToCart(id)} className='-button'>+</button>
      </div>
    ...
    <button onClick={()=>deletecart(id)} className='delete'>Delete</button>
    </div>
    </div>
    </div>
