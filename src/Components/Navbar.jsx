    ...
    <>
      <div className="navbar">
        <div className="nav">
         ...
         {itemCount > 0 && <span style={{color:'red',minWidth:'19px', minHeight:'19px',backgroundColor:'white',borderRadius:'15px',display:'flex',justifyContent:'center',alignItems:'center',fontSize:'9px',fontWeight:'800',position:'absolute',marginLeft:'23px',marginBottom:'11px'}}> <>{itemCount}</></span>}
