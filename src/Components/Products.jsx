...
function Products() {
  ...
  const filterdProduct = PRODUCTS.filter((store) => store.name.toLowerCase());
        ...
        <div className="sticky">
          <div className="sticky-div">
            <div className="filters">
              ...
              <p className="clearText" onClick={() => clearFilter(null)}>
                Clear All
              </p>
            </div>

            <div className="Pumafilter">
              <span className="pumaText" onClick={() => capSearchBrand("Puma")}>
                Puma
              </span>
            ...
            <div className="Pumafilter">
              <span
                className="pumaText"
                onClick={() => capSearchBrand("Royel Enfield")}
              >
                Royel Enfield
              </span>
              <span className="cap">Men's Cap</span>
            ...
            <div className="Pumafilter">
              <span
                className="pumaText"
                onClick={() => capSearchBrand("WoodLand")}
              >
                WoodLand
              </span>
              <span className="cap">Men's Cap</span>
            ...
            <div className="Pumafilter">
              <span
                className="pumaText"
                onClick={() => capSearchBrand("Peter England")}
              >
                Peter England
              </span>
              <span className="cap">Men's Cap</span>
