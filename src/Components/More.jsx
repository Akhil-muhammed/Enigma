...
function More() {
  ...
  const { cartitems, addToCart, taxes, shareUrOpinion, size } =
    ...
    <div className="main-morediv">
      <div className="morediv">
        ...
        <div className="details">
          ...
          <span className="head-discription">
      ...
      <div className="deraction-img">
        <div className="sub-deraction-img">
          <img
            className="firstimg"
            onClick={() => setimage(selectedProduct.img)}
            src={selectedProduct.img}
          />
          <img
            className="firstimg"
            onClick={() => setimage(selectedProduct.imgf)}
            src={selectedProduct.imgf}
          />
          <img
            className="firstimg"
            onClick={() => setimage(selectedProduct.imgl)}
            src={selectedProduct.imgl}
          />
          <img
            className="firstimg"
            onClick={() => setimage(selectedProduct.imgr)}
            src={selectedProduct.imgr}
          />
        </div>
      </div>
    </div>
